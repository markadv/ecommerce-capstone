<?php defined("BASEPATH") or exit("No direct script access allowed"); ?>
        ...
        <nav class="navbar border-bottom px-5 py-4 bg-light">
            <div class="container-fluid">
                ...
                <!-- <form action="catalog" class="d-flex w-50 ms-auto me-auto" method="GET" role="search">
                    <input name="search" class="form-control me-2" type="search" placeholder="Search" aria-label="Search" />
                    <input class="btn btn-outline-primary" type="submit" value="Search" />
                </form> -->
                <a href="<?= base_url() ?>cart" class="cart position-relative" aria-label="View your shopping cart">
